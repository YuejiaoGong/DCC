...
double* Benchmarks::readOvector()
{
  ...
  stringstream ss;
  ss<< "./cec2013/cdatafiles/" << "F" << ID << "-xopt.txt";
...
int* Benchmarks::readPermVector(){
  ...
  stringstream ss;
  ss<< "./cec2013/cdatafiles/" << "F" << ID << "-p.txt";
  ifstream file (ss.str());
  int c=0;
  string value;
...
double** Benchmarks::readR(int sub_dim)
{
  ...
  stringstream ss;
  ss<< "./cec2013/cdatafiles/" << "F" << ID << "-R"<<sub_dim<<".txt";
  // cout<<ss.str()<<endl;
...
int* Benchmarks::readS(int num)
{
  ...
  stringstream ss;
  ss<< "./cec2013/cdatafiles/" << "F" << ID << "-s.txt";
  ifstream file (ss.str());
  int c=0;
  string value;
  if (file.is_open())
...
double* Benchmarks::readW(int num)
{
  ...
  stringstream ss;
  ss<< "./cec2013/cdatafiles/" << "F" << ID << "-w.txt";
  ifstream file (ss.str());
  int c=0;
  string value;
  if (file.is_open())
